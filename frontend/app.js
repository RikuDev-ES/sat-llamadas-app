...
function filtrarYRenderizar() {
  ...
  // Filtrar por nombre, teléfono, motivo o notas
  llamadasFiltradas = llamadas.filter((l) =>
    [l.nombre_llamante, l.numero_telefono, l.motivo, l.notas]
...
function renderizarTabla() {
  ...
  if (llamadasFiltradas.length === 0) {
    ...
    td.colSpan = 7;
    td.textContent = busquedaInput.value
...
async function guardarLlamada(e) {
  ...
  try {
    ...
    mostrarError("Error al guardar la llamada");
  }
}
